...
def main ():
 ...
 #  ./temporal_series/most_weigh_ins/weigh_in_time_serie_days100_top500.dat
 #  
 #  0 233.41 0.0 33.4871897959 0:00:00 2008-10-05 00:00:00 0:00:00
 #  1 230.32 -1.32385073476 33.0438693878 1 day, 0:00:00 2008-10-06 00:00:00 1 day, 0:00:00
 #  2 229.32 -1.75228139326 32.9004 2 days, 0:00:00 2008-10-07 00:00:00 1 day, 0:00:00
 #  3 227.12 -2.69482884195 32.5847673469 3 days, 0:00:00 2008-10-08 00:00:00 1 day, 0:00:00
 #  4 225.53 -3.37603358896 32.3566510204 5 days, 0:00:00 2008-10-10 00:00:00 2 days, 0:00:00
 #  5 225.13 -3.54740585236 32.2992632653 6 days, 0:00:00 2008-10-11 00:00:00 1 day, 0:00:00
 #  6 225.53 -3.37603358896 32.3566510204 7 days, 0:00:00 2008-10-12 00:00:00 1 day, 0:00:00
...
#        file_name="../Results/Time_evol_tot_num_infected_links_nodes_GC_monthly_slicing"
        file_name="../Results/Time_evol_tot_num_infected_links_nodes_GC_monthly_slicing_no_big_peaks"
 #       file_name="../Results/Time_evol_tot_num_infected_links_nodes_GC_monthly_slicing_no_big_peaks_only_until200"

      #  file_name="../Results/Time_evol_tot_num_infected_links_nodes_GC_monthly_slicing_until_day200"

    ##  time  num_inf_links  fract_inf_links  num_inf_nodes  fract_inf_nodes  GC            
        file=open(file_name+".dat",'r')
        list_lines_file=file.readlines()



        output_name=file_name+"_t_points_segments"+str(min_lenght)+"_"+str(significance_threshold)+".dat"
        file2=open(output_name,'wt')
        ...
        for line in list_lines_file:
            ...
            vector=[]                                      
            vector.append(float(list[0]))   # time
            vector.append(float(list[2]))   # magnitude
            ...
            if num_points>=min_lenght:  # if the serie is too short, i wont cut it any further
                ...
                if significance_t_max > significance_threshold :
                    if  len(segment1) > min_lenght  and len(segment2) > min_lenght:
                        ...
                        print "max_t:", t_max, "at time:",list_evolution[index_max_t][0],"significance:",significance_t_max,"           I:",I,"eta:",eta,"nu:",nu,"x:",x,"a:",a,"N:",num_points
                     ...
                     print "max_t:", t_max, "at time:",list_evolution[index_max_t][0],"NON significant!:",significance_t_max,"           I:",I,"eta:",eta,"nu:",nu,"x:",x,"a:",a,"N:",num_points
