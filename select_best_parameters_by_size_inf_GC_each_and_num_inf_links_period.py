...
def main():
    ...
    optimize_by = "GC_num_inf_links"   #"spearman"  #  "GC_num_inf_links" #"spearman"     #"combo_dist"     #"testing"     #"avg_dist"  # "avg_dist"  or "pearson"  or "spearman"  or  "pearson_diff_with_previous" "spearman_combined"  
                          # Spearman doesnt assume normality
    ...
    # time num_inf_links frac_inf_links num_inf_nodes fract_inf_nodes  GC_inf  N  L
    #  0         1            2               3             4           5  6  7
        ...
        for  prob_inf in list_prob_inf:                        
            for  prob_recovery in list_prob_recovery:                
                ...
                try:
                    ...
                    #####################
                    if optimize_by ==  "GC_num_inf_links":

                        measure_correlation_num_inf_links=calculate_spearman_correlation_two_curves(dict_t_fract_inf_links_real, dict_t_fract_inf_links_simu)   
                        measure_correlation_inf_GC=calculate_spearman_correlation_two_curves(dict_t_inf_GC_real, dict_t_inf_GC_simu)
                       ...
                       # print "measure corr. inf links:",measure_correlation_num_inf_links,  "measure corr. inf GC:",measure_correlation_inf_GC
                        ...
                        try:
                            ...
                            int(measure_correlation_inf_GC[0])
                            measure_correlation= ((measure_correlation_num_inf_links[0] + measure_correlation_inf_GC[0])/2., measure_correlation_num_inf_links[1], measure_correlation_inf_GC[1])

                            #print  " tot  (avg corr. coef, ang both original p-values):",measure_correlation
                        except ValueError:
                            measure_correlation="NA"
    ...
    #### i sort the dict by value  
    if  optimize_by == "pearson"  or   optimize_by == "spearman"  or   optimize_by == "GC_num_inf_links":
